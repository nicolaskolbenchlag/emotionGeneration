...
def generateNoise(batchSize, noiseShape):
    return np.random.normal(0, 1, size=(batchSize,) + noiseShape)
    ...
    def fit(self, epochs, batchSize):  
        ...
        for epoch in range(epochs):
            ...
            for iBatch in range(0, 100, batchSize):
                ...
                noise = generateNoise(len(realImagesX), self.noiseShape)
                ...
                ganX = generateNoise(len(realImagesX), self.noiseShape)
                ganY = realDataY
